...
func Init() bool {
	...
	ReminderType = flag.String("reminderType", "", "Reminder Type")
	...
	if *CSVFilePath != "" && *ReminderType == "" && *Type == "reminder" {
		log.Println("Reminder Type is mandatory for reminder csv uploads")
		return false
	}
